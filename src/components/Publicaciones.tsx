...
import { FileText, ExternalLink, Calendar, BookMarked, ChevronDown, ChevronUp } from "lucide-react";
...
function ArticleCard({ pub }: { pub: (typeof publications)[number] }) {
  ...
  return (
    <article className="glass-card p-6 md:p-8 group">
    ...
    <section id="publicaciones" className="relative gradient-section-alt py-24 md:py-36 overflow-hidden">
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-10">
          <span className="inline-flex items-center gap-2 px-5 py-2 rounded-full bg-gradient-to-r from-purple-vivid/15 to-magenta/15 border border-purple-vivid/20 text-sm text-lavender/70">
            <FileText size={16} className="text-fuchsia" />
